  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Quick Role Fillers (Owner vs Admin) */}
        <div
          style={{
            marginTop: '18px',
            paddingTop: '14px',
        ...
        >
          <div style={{ fontSize: '12px', fontWeight: 700, color: '#64748b', textAlign: 'center', marginBottom: '2px' }}>
            ⚡ تعبئة سريعة لاختبار الصلاحيات:
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '8px' }}>
            <button
              type="button"
              onClick={() => {
                const ownerUser = state?.orgSettings?.ownerUsername || 'owner';
                const ownerPass = state?.orgSettings?.ownerPassword || 'owner123';
                setUsername(ownerUser);
            ...
            >
              <span>👑 يوزر المالك (Owner)</span>
              <span style={{ fontSize: '10px', color: '#b45309', fontWeight: 600 }}>بدون أقفال (حر)</span>
            </button>

            <button
              type="button"
              onClick={() => {
                const adminUser = state?.orgSettings?.adminUsername || 'admin';
                const adminPass = state?.orgSettings?.adminPassword || '123';
            ...
            >
              <span>🛡️ يوزر الأدمن (Admin)</span>
              <span style={{ fontSize: '10px', color: '#0d9488', fontWeight: 600 }}>يطلب تصريح المالك</span>
            </button>
          </div>
        </div>
