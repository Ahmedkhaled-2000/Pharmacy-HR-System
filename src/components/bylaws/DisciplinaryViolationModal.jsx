  ...
  const handleSubmit = async (e) => {
    ...
    const performSaveViolation = async () => {
      const newViolationRequest = {
        ...
        penaltyDays: effectiveDeductionDays,
        dailyRate: dailyRate,
        hourlyRate: hourlyRate,
        amount: effectiveDeductionAmount,
        penaltyAmount: effectiveDeductionAmount,
        date: violationDate,
        reason: incidentDetails || ruleTitle,
        details: incidentDetails,
        notes: incidentDetails,
        investigationNotes: investigationNotes,
        attachmentName: attachmentName,
        attachmentData: attachmentData,
        attachmentType: attachmentType,
        attachmentSize: attachmentSize,
        photoUrl: attachmentType === 'image' ? attachmentData : null,
        videoUrl: attachmentType === 'video' ? attachmentData : null,
        isOverride: isOverrideActive,
        overrideReason: isOverrideActive ? overrideReason : null,
        createdRole: isAdmin ? 'admin' : 'branch',
        createdByName: isAdmin ? 'الإدارة العليا' : (state.currentUserName || 'مدير الفرع'),
