...
export default function WhatsAppCenterModule({
  ...
  // ── تحميل أداة تشغيل خادم الواتساب الاحترافية (تفتح واجهة ويندوز مباشرة بدون أي نوافذ سوداء) ──
  const handleDownloadBackupScript = useCallback(() => {
    try {
      const link = document.createElement('a');
      link.href = '/scripts/تشغيل_خادم_الواتساب_احتياطي.exe';
      link.download = 'تشغيل_خادم_الواتساب_احتياطي.exe';
      document.body.appendChild(link);
      link.click();
      document.body.removeChild(link);
      showToast?.('📥 تم تنزيل أداة تشغيل خادم الواتساب الاحترافية بنجاح (نافذة رسومية مباشرة بدون أي شاشة سوداء)!');
    } catch (e) {
